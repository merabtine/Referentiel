...
if page == "Accueil":
    ...
    **Objectifs principaux :**
    ...
    st.markdown("""
    Ici, vous pouvez explorer différents modèles d’IA, leurs APIs et exemples d’utilisation (ex: OpenRouter, Together AI, etc.).  
    (Contenu à compléter selon ton besoin)
    """)
